...
# Khai báo
file_new_gct_vn = resource_path("gct_vn_new.txt")
file_new_gct_en = resource_path("gct_en_new.txt")
file_gct_csv = resource_path("link_eng_vn_gct.csv")
file_txt = resource_path("gct_vn_new.txt")
file_csv = resource_path("link_eng_vn_gct.csv")
